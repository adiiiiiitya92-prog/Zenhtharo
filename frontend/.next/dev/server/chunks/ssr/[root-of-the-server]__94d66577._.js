...
const ContactForm = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setStatus('sending');
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('http://localhost:5000/api/contact', formData);
            setStatus('success');
            setFormData({
                name: '',
                email: '',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__94d66577._.js.map