...
const ContactForm = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setStatus('sending');
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('http://localhost:5000/api/contact', formData);
            setStatus('success');
            setFormData({
                name: '',
                email: '',
...
_s(ContactForm, "Bee0hVKG2ufEVwJOfb1o1JWKyjM=");
_c = ContactForm;
...
//# sourceMappingURL=components_ContactForm_jsx_a39ace57._.js.map