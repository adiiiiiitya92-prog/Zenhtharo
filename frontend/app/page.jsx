        ...
        <>
            ...
            <section className="py-20 bg-black">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-3xl md:text-5xl font-bold mb-6">About <span className="text-royal-blue">Zentharo</span></h2>
                    <p className="text-gray-400 max-w-3xl mx-auto mb-10 text-lg">
                        We are a team of visionary creatives and technical experts dedicated to transforming brands. At Zentharo, we don't just follow trends; we set them. Our mission is to elevate your digital presence through strategic marketing and innovative design.
                    </p>
